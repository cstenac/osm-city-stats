<?php
  ...
  while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {
    ...
    if ($has_linestring_in_ways) {
        ...
        safe_dml_query("INSERT INTO city_closedway SELECT $id, id, tags, ST_MakePolygon(linestring) from ways INNER JOIN city_geom cg ON ST_Intersects(cg.geom_dump, ways.linestring) WHERE cg.relation_id=$id AND ways.is_polygon = 't'");
    } else {
