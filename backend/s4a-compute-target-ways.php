<?php
  ...
  while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {
    ...
    time_start();
    safe_dml_query("INSERT INTO city_way SELECT $id, wg.way_id, wg.tags,  wg.geom from way_geometry wg INNER JOIN city_geom cg ON ST_Intersects(cg.geom_dump, wg.geom) WHERE cg.relation_id=$id");
    time_end("ways");
  }
  pg_query("COMMIT");
?>
